...
<footer class="bg-zinc-900 pt-10 lg:pt-16">

<div class="mx-auto w-full max-w-screen-xl">
    <div class="grid grid-cols-2 gap-8 px-4 py-6 lg:py-8 md:grid-cols-4">
    <div v-for="(elements, name) of sections" :key="name">
...
<div class="px-4 py-6 md:flex md:items-center md:justify-between">
    <span class="text-sm lg:text-base text-gray-300 text-center">
        Copyright &copy; {{ copyrightYear() }} KAAN&nbsp;Group s.r.o.
    </span>
